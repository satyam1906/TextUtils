    ...
    <div>
      <nav className={`navbar navbar-expand-lg navbar-${props.mode} bg-${props.mode}`}>
        <div className="container-fluid">
          ...
          <a className="navbar-brand" href="#">{props.title}</a> {/**Advantage of using 'Link' and 'to' is that our page will not load again and again as in the case of 'a' and 'href' */}
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              <li className="nav-item">
                ...
                <a className="nav-link active" aria-current="page" href="#">Home</a> {/**Replace 'a'-->'link' and 'href'-->'to' for using React Router*/}
              </li>
              <li className="nav-item">
                {/* <Link className="nav-link" to="/about">{props.aboutText}</Link> *Replace 'a'-->'link' and 'href'-->'to' for using React Router */}
                <a className="nav-link" href="#">{props.aboutText}</a> {/**Replace 'a'-->'link' and 'href'-->'to' for using React Router */}
              </li>
            </ul> 
